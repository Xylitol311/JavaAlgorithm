...
/*
학생들의 번호와 키의 관계를 각각 노드와 간선 정보로 보고 입력받고 노드 배열에 저장한다.
정보를 입력할 때 진입 차수에 대한 정보를 담은 배열을 만들어 진입 차수도 함께 저장한다.
이렇게 만들어진 노드 배열과 진입 차수를 활용. 위상 정렬을 이용해 줄을 세운 결과를 출력한다.
